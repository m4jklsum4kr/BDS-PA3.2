...
import org.but.feec.javafx.services.MeetingService;
...
public class PersonsController {
    ...
    @FXML
    private TableColumn<MeetingView, Long> meetingId;
    @FXML
    private TableColumn<MeetingView, String> meetingNote;
    @FXML
    private TableColumn<MeetingView, String> meetingPlace;
    @FXML
    private TableColumn<MeetingView, String> meetingStart;
    @FXML
    private TableColumn<MeetingView, String> meetingEnd;
    @FXML
    private TableView<MeetingView> systemMeetingTableView;
//    @FXML
...
//        GlyphsDude.setIcon(exitMenuItem, FontAwesomeIcon.CLOSE, "1em");
        ...
        meetingId.setCellValueFactory(new PropertyValueFactory<MeetingView, Long>("id"));
        meetingNote.setCellValueFactory(new PropertyValueFactory<MeetingView, String>("note"));
        meetingPlace.setCellValueFactory(new PropertyValueFactory<MeetingView, String>("place"));
        meetingStart.setCellValueFactory(new PropertyValueFactory<MeetingView, String>("start"));
        meetingEnd.setCellValueFactory(new PropertyValueFactory<MeetingView, String>("end"));
        ...
        ObservableList<MeetingView> observableMeetingList = initializeMeetingsData();
        systemMeetingTableView.setItems(observableMeetingList);

        systemPersonsTableView.getSortOrder().add(personsId);
        systemMeetingTableView.getSortOrder().add(meetingId);
    ...
    private ObservableList<MeetingView> initializeMeetingsData() {
        List<MeetingView> meetings = meetingService.getAllMeetings();
        return FXCollections.observableArrayList(meetings);
    }
